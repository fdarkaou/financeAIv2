<template>
  <LayoutAuthenticated>
    <SectionMain>
      <BreadCrumb :projectName="pageName" class="py-4" />
      <SectionTitleLineWithButton :icon="mdiFilterCheckOutline" title="Generate a personal investment plan" />

    <div v-if="step === 'complete'">
                <div class="mockup-window border bg-base-300 px-4 py-4" data-theme="dark">
                  ...
                  <div class="py-2"> </div>
                  <div class="mockup-window border bg-base-300 px-4 py-2" data-theme="dark">
                    <div class="text-sm">
                        <p>Hey <b>{{ name }}</b>,</p>
                  ...
                  <div class="py-2"> </div>
                  <CardBox>          
                    <LoadingComponent v-if="!financieel_plan" />
                  </CardBox>
                    <div v-if="financieel_plan" class="mockup-window border bg-base-300 px-4 py-4" data-theme="dark">
                      <SectionTitleLineWithButton :icon="mdiCash100" title="Je persoonlijk financieel plan" />
                      <CardBox>          
      ...
      <div v-if="step != 'complete'" class="mockup-window border bg-base-300 px-4" data-theme="dark">
      <form>
				<!-- Top Navigation -->
				<div class="px-4">
  ...
  import { mdiFilterCheckOutline, mdiCash100 } from "@mdi/js";
...
export default {
    ...
    data() {
        return {
            ...
            mdiCash100,
            pageName: "Moralis Authentication",
            currentUser: null,
            step: 1,
            name: null,
